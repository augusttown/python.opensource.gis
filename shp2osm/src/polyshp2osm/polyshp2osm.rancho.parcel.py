...
__version__ = "$Id: polyshp2osm.py 12999 2009-01-06 20:19:16Z crschmidt $"
...
def number_fld(data):
    if ('number' in data) and (data['number']):
        ...
        return [('_addr:housenumber_', data['number'])]
    return None        
...
def typeuse_fld(data):
    ...
    if typeuseCode == '100':
        tags.append(['landuse', 'industrial'])
        tags.append(['description:en', 'Storage warehouse'])
    elif typeuseCode == '103':
        tags.append(['landuse', 'industrial'])
        tags.append(['description:en', 'Mini-storage warehouse'])  
    elif typeuseCode == '113':
        tags.append(['landuse', 'industrial'])
        tags.append(['description:en', 'Light industrial'])
    elif typeuseCode == '173':
        tags.append(['landuse', 'commercial'])
        tags.append(['description:en', 'Mutual water company']) 
    elif typeuseCode == '210':
        tags.append(['landuse', 'commercial'])
        #tags.append(['building', 'office'])
        tags.append(['description:en', 'General office']) 
    elif typeuseCode == '212':
        tags.append(['landuse', 'commercial'])
        #tags.append(['building', 'yes'])
        tags.append(['amenity', 'bank'])
        tags.append(['description:en', 'Bank, S&L']) 
    elif typeuseCode == '230':
        tags.append(['landuse', 'commercial'])
        #tags.append(['building', 'office'])
        #tags.append(['office', 'medical'])
        #tags.append(['amenity', 'doctors'])
        tags.append(['description:en', 'Medical office'])
    elif typeuseCode == '232':
        tags.append(['landuse', 'commercial'])
        #tags.append(['building', 'office'])
        #tags.append(['office', 'veterinary;'])
        #tags.append(['amenity', 'veterinary;'])
        tags.append(['description:en', 'Veterinary office']) 
    elif typeuseCode == '300':
        tags.append(['landuse', 'retail'])
        #tags.append(['building', 'retail'])
        tags.append(['description:en', 'Retail store']) 
    elif typeuseCode == '304':
        tags.append(['landuse', 'retail'])
        tags.append(['description:en', 'Retail strip'])    
    elif typeuseCode == '305':
        tags.append(['landuse', 'retail'])
        #tags.append(['building', 'retail'])
        #tags.append(['shop', 'mall'])
        tags.append(['description:en', 'Shopping center'])
    elif typeuseCode == '313':
        tags.append(['landuse', 'retail'])
        #tags.append(['building', 'retail'])
        #tags.append(['amenity', 'fuel'])
        tags.append(['shop', 'convenience'])
    elif typeuseCode == '314':
        tags.append(['landuse', 'retail'])
        #tags.append(['amenity', 'marketplace'])
        #tags.append(['shop', 'market'])
        tags.append(['description:en', 'Market'])
    elif typeuseCode == '315':
        tags.append(['landuse', 'retail'])
        #tags.append(['building', 'supermarket'])
        #tags.append(['shop', 'supermarket'])
        tags.append(['description:en', 'Supermarket'])    
    elif typeuseCode == '320':
        tags.append(['landuse', 'retail'])
        #tags.append(['amenity', 'fast_food'])
        tags.append(['description:en', 'Fast food']) 
    elif typeuseCode == '321':
        tags.append(['landuse', 'retail'])
        #tags.append(['amenity', 'restaurant'])
        tags.append(['description:en', 'Restaurant'])
    elif typeuseCode == '322':
        tags.append(['landuse', 'retail'])
        #tags.append(['amenity', 'bar'])
        tags.append(['description:en', 'Bar, tavern'])
    elif typeuseCode == '330':
        tags.append(['landuse', 'commercial'])
        #tags.append(['building', 'hotel'])
        #tags.append(['tourism', 'hotel'])
        tags.append(['description:en', 'Hotel'])   
    elif typeuseCode == '331':
        tags.append(['landuse', 'commercial'])
        #tags.append(['building', 'hotel'])
        #tags.append(['tourism', 'motel'])
        tags.append(['description:en', 'Motel'])
    elif typeuseCode == '343':
        tags.append(['landuse', 'commercial'])
        #tags.append(['building', 'service'])
        tags.append(['description:en', 'Service station'])
    elif typeuseCode == '347':
        tags.append(['landuse', 'service'])
        #tags.append(['building', 'service'])
        #tags.append(['amenity', 'car_wash'])
        tags.append(['description:en', 'Car wash, automatic'])
    elif typeuseCode == '400':
        tags.append(['landuse', 'cemetery'])
        tags.append(['description:en', 'Cemetery'])  
    elif typeuseCode == '471':
        tags.append(['landuse', 'school'])
        #tags.append(['building', 'school'])
        #tags.append(['amenity', 'school'])
        tags.append(['description:en', 'Pre-school/day care center'])
    elif typeuseCode == '472':
        tags.append(['landuse', 'school'])
        #tags.append(['building', 'school'])
        #tags.append(['amenity', 'school'])
        tags.append(['description:en', 'Elementary school'])  
    elif typeuseCode == '473':
        tags.append(['landuse', 'school'])
        #tags.append(['building', 'school'])
        #tags.append(['amenity', 'school'])
        tags.append(['description:en', 'Secondary school']) 
    elif typeuseCode == '474':
        tags.append(['landuse', 'school'])
        #tags.append(['building', 'school'])
        #tags.append(['amenity', 'college'])
        tags.append(['description:en', 'College'])
    elif typeuseCode == '480':
        tags.append(['landuse', 'school'])
        #tags.append(['building', 'yes'])
        tags.append(['description:en', 'Multipurpose building'])
    elif typeuseCode == '510':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'house'])
        tags.append(['description:en', 'SFR (Single Family Residence)'])
    elif typeuseCode == '530':
        tags.append(['landuse', 'residential'])
    elif typeuseCode == '599':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'yes'])
        #tags.append(['building', 'condo'])
        tags.append(['description:en', 'Condo']) 
    elif typeuseCode == '600':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'house'])
        tags.append(['description:en', 'SFR 2 (Two Single Family Residence)'])
    elif typeuseCode == '601':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'house'])
        tags.append(['description:en', 'SFR 3 (Three Single Family Residence)'])
    elif typeuseCode == '602':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'house'])
        tags.append(['description:en', 'SFR 4 (Four Single Family Residence)'])
    elif typeuseCode == '621':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'apartments'])
        tags.append(['description:en', 'Apartment, 15 units and up'])
    elif typeuseCode == '622':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'apartments'])
        tags.append(['description:en', 'Townhouse apartment, 15 units and up'])
    elif typeuseCode == '630':
        tags.append(['landuse', 'residential'])
        #tags.append(['building', 'apartments'])
        tags.append(['description:en', 'Condos used as apartments'])
    elif typeuseCode == '650':
        tags.append(['landuse', 'recreation_ground'])
        #tags.append(['leisure', 'park'])
        tags.append(['description:en', 'Manufactured home park'])
    elif typeuseCode == '751':
        tags.append(['landuse', 'farm'])
        #tags.append(['building', 'farm'])
        tags.append(['description:en', 'Poultry'])
    
    else:
        print('typeuse code unmatched: %s'%typeuseCode)
    return tags
...
# used for tags which are usually calculated in a GIS.
